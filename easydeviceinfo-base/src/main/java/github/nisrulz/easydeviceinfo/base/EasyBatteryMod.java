...
public class EasyBatteryMod {
    ...
    public final String getBatteryTechnology() {
        return CheckValidityUtil.checkValidData(this.getBatteryStatusIntent().getStringExtra(BatteryManager.EXTRA_TECHNOLOGY));
    }
    ...
    public final boolean isBatteryPresent() {
        return (getBatteryStatusIntent().getExtras() != null) && this.getBatteryStatusIntent().getExtras().getBoolean(BatteryManager.EXTRA_PRESENT);
    }
