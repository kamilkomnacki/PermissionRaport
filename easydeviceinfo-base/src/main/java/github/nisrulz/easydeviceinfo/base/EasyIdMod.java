...
public class EasyIdMod {
    ...
    public final String[] getAccounts() {
        String[] result = null;
        if ((Build.VERSION.SDK_INT < Build.VERSION_CODES.O) && PermissionUtil.hasPermission(this.context, permission.GET_ACCOUNTS)) {
    ...
    public final String getAndroidID() {
        return CheckValidityUtil.checkValidData(Secure.getString(this.context.getContentResolver(), Secure.ANDROID_ID));
    }
    ...
    public final String getPseudoUniqueID() {
        ...
        devIDShort += VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? Build.SUPPORTED_ABIS[0].length() % 10 : Build.CPU_ABI.length() % 10;
    ...
    public final String getUA() {
        ...
        final String result;
        result = VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 ? WebSettings.getDefaultUserAgent(this.context) + "__" + systemUa : new WebView(this.context).getSettings().getUserAgentString() + "__" + systemUa;
        return CheckValidityUtil.checkValidData(result);
    }
}
