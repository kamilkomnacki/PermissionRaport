...
public class EasyLocationMod {
    ...
    public EasyLocationMod(final Context context) {
        this.hasFineLocationPermission = PermissionUtil.hasPermission(context, permission.ACCESS_FINE_LOCATION);
        this.hasCoarseLocationPermission = PermissionUtil.hasPermission(context, permission.ACCESS_COARSE_LOCATION);
