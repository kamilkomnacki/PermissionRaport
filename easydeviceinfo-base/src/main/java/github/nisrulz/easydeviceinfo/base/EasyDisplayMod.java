...
public class EasyDisplayMod {
    ...
    public final int getLayoutDirection() {
        return VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 ? this.context.getResources().getConfiguration().getLayoutDirection() : this.context.getResources().getConfiguration().SCREENLAYOUT_LAYOUTDIR_LTR;
    }
    ...
    public final boolean isScreenRound() {
        return VERSION.SDK_INT >= Build.VERSION_CODES.M && this.context.getResources().getConfiguration().isScreenRound();
    }
}
