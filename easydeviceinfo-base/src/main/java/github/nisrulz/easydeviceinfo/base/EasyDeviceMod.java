...
public class EasyDeviceMod {
    ...
    public final String getPhoneNo() {
        String result = null;
        if (PermissionUtil.hasPermission(this.context, permission.READ_PHONE_STATE) && (tm.getLine1Number() != null)) {
    ...
    public final boolean isDeviceRooted() {
        final String su = "su";
        final String[] locations = {"/sbin/", "/system/bin/", "/system/xbin/", "/system/sd/xbin/", "/system/bin/failsafe/", "/data/local/xbin/", "/data/local/bin/", "/data/local/"};
